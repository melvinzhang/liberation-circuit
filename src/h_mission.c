...
//default:
	 ...
	 case MISSION_TUTORIAL2:
        do_script("story/tutorial/tute2/tute2.lua");
/*
...
*/
	 ...
	 case MISSION_GREEN_1:
        do_script("story/green/green1/green1.lua");
	    break;
	 ...
	 case MISSION_GREEN_CAPITAL:
        do_script("story/green/green3/green3.lua");
	    break;
	 ...
	 case MISSION_YELLOW_2:
        do_script("story/yellow/yellow2/yellow2.lua");
  	    break;


	 case MISSION_YELLOW_CAPITAL:
        do_script("story/yellow/yellow3/yellow3.lua");
	    break;
	 ...
	 case MISSION_PURPLE_CAPITAL:
        do_script("story/purple/purple3/purple3.lua");
  	    break;
	 ...
	 case MISSION_ORANGE_2:
        do_script("story/orange/orange2/orange2.lua");
   	    break;


	 case MISSION_ORANGE_CAPITAL:
        do_script("story/orange/orange3/orange3.lua");
	    break;


	 case MISSION_RED_1:
        do_script("story/red/red1/red1.lua");
 	    break;
